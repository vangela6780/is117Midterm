  ...
  return (
    <div className="grid gap-6 lg:grid-cols-[0.9fr_1.1fr]">
      <div className="artifact-card p-6">
        ...
        <p className="impact-number mt-5 text-rust">{(pledges * gallonsPerPledge).toLocaleString()}</p>
        <p className="display-type mt-3 text-2xl uppercase text-ash md:text-3xl">gallons symbolically saved</p>
        ...
        <button
          ...
          className="mt-6 border-2 border-ash bg-teal px-5 py-4 text-sm font-semibold uppercase tracking-[0.14em] text-mist transition hover:bg-ash"
        >
          Add your pledge
        </button>
        <p className="mt-3 text-xs uppercase tracking-[0.14em] text-ash/60">{pledges.toLocaleString()} community commitments recorded</p>
      </div>
